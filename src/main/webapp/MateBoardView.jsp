		...
		<form name="writeFrm">
			...
			<div class="schedule">
				<div style="line-height:28px;">
					...
					<i class="fa-solid fa-calendar-days" style="font-size: 25px; margin-right: 50px;"></i> &nbsp;&nbsp;&nbsp; <b>장소 :</b> ${dto.m_name } &nbsp;&nbsp;&nbsp;&nbsp; <b>예정일 :</b> &nbsp;&nbsp;<span id="dDay">${dDay }</span>  &nbsp;&nbsp;&nbsp;&nbsp; <b>제한 인원 : </b>&nbsp;&nbsp;${dto.mateLimit } &nbsp;/&nbsp; <span id="cnt">${cnt }
				</div>
				<div class="btnDiv">
					<c:choose>
