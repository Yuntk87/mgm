...
<%@ include file="Navi.jsp" %>
   	<div style="width: 100%; position: relative;">
        <img style="opacity: 0.7;" src="./img/page_bg7.jpg" width="100%" height="560px" alt="">
				...
				<c:otherwise>
					<c:forEach items="${boardLists }" var="b">
						...
						<tr class="last">
							...
							<td colspan="2" width="15%" style="text-align:left; font-size:15px; cursor:pointer;" onClick="location.href='./yourpage?id=${b.id}'" style="cursor:pointer;">${b.nickName }</td>
